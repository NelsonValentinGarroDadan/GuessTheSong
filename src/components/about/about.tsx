    ...
    return (
        <section className="flex justify-start h-full min-h-screen items-center flex-col bg-bg-muted-dark pt-5 px-6">
            ...
            <div className="bg-purple-600 w-full max-w-4xl p-6 my-6 rounded-lg flex flex-col">
                <h3 className="text-text-dark text-left text-xl xl:text-xl mb-4">
                    🎵 ¿Qué es GuessTheSong?
                </h3>
                <p className="text-text-dark text-left text-base xl:text-lg mb-6">
                ...
                <ul className="text-text-dark text-left text-base xl:text-lg  list-disc pl-6 mb-6">
                    <li className="text-base xl:text-lg ">En 1s → +5 puntos</li>
                    <li className="text-base xl:text-lg ">En 2s → +4 puntos</li>
                    <li className="text-base xl:text-lg ">En 3s → +3 puntos</li>
                    <li className="text-base xl:text-lg ">En 4s → +2 puntos</li>
                    <li className="text-base xl:text-lg ">En 5s → +1 punto</li>
                </ul>
                <p className="text-text-dark text-left ttext-md xl:text-lg mb-6">
                ...
                <h3 className="text-text-dark text-left text-xl xl:text-2xl mb-4">
                ...
                <p className="text-text-dark text-left text-base xl:text-lg mb-2">
                ...
                <p className="text-text-dark text-left text-base xl:text-lg font-bold">
