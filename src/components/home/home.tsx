    ...
    return(
        <section className="relative w-full min-h-screen h-full pb-5 flex justify-center items-center flex-col bg-bg-muted-dark pt-5">
            <div className="flex justify-start items-center flex-col z-10">
                ...
                <button className="mb-7 xl:mb-0 bg-purple-600 text-white px-10 py-2 rounded-full cursor-pointer group border-purple-600 border hover:bg-transparent transition-all ease-in-out duration-300 ">
